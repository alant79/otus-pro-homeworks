...
public class AppComponentsContainerImpl implements AppComponentsContainer {
    ...
    record NamesBean(String nameMethod, String nameReturnParam) {
        NamesBean(String nameMethod, String nameReturnParam) {
            this.nameMethod = nameMethod;
            this.nameReturnParam = nameReturnParam;
        }
    }
    ...
    private void sortAppComponents() {
        appComponents.clear();
        orderClasses.entrySet().stream().sorted(Map.Entry.<Class, Integer>comparingByValue()).forEach(en -> {
